...
import { useRegions, useClubCategories } from '@/hooks/useEnums';

const Clubs: React.FC = () => {
  const { isLoading: regionsLoading } = useRegions();
  const { data: clubs, isLoading: clubsLoading } = useClubCategories();
        ...
        <div className="col-12">
          <div className="box">
            <div className="box-header">
              <h4 className="box-title">All Clubs by Category</h4>
            </div>
